...
@section('content')
            ...
            <ul class="flex flex-col">
                ...
                @foreach ($course->posts as $post)
                    <li class="flex items-center text-gray-600 mt-2">
                        ...
                        @if ($post->free)
                            <span
                                class="text-xs text-gray-500 font-semibold bg-gray-300 px-4 rounded-full ml-auto">Gratis</span>
                        @else
                            <span
                                class="text-xs text-gray-500 font-semibold bg-gray-300 px-6 rounded-full ml-auto">Pagado</span>
                        @endif
                    </li>
                @endforeach
            </ul>
    ...
    <div class="text-center mt-4">
        ...
        <h2 class="text-xl text-gray-600">Fórmate online como profesional de tecnologia</h2>
    </div>
